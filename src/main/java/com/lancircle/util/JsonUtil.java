...
/**
 * Small JSON helper for LAN Circle's flat wire protocol.
 *
 * <p>This is intentionally limited to the value shapes used by the app:
 * strings, numbers and arrays of strings. Keeping it local avoids forcing a
 * JSON dependency onto desktop users who only need a runnable JAR.</p>
 */
